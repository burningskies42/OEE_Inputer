...
Global settings As cSettingsFile

' returns the troubleshooter email from the settings file
Public Function getTroubleshooter()

    Set settings = New cSettingsFile
    getTroubleshooter = settings.tsEmail

End Function

' returns the Ausschuss email from the settings file
Public Function getAusschussEmail()

    Set settings = New cSettingsFile
    getAusschussEmail = settings.AusschussEmail
...
Public Sub ExportAllComponents()
    ...
    If ActiveWorkbook.Path = "" Then
        ...
        Exit Sub
    End If
    destDir = ActiveWorkbook.Path & "\Code"
